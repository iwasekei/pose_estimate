...
def get_arguments():
    ...
    parser.add_argument('--n_stage', type=int, default=4,
                        ...
                        'Default is 4 stages.')
    parser.add_argument('--cpm_init_model', type=str, default='',
                        help='Path to chainer model to load before trainig.')
    parser.add_argument('--unet_init_model', type=str, default='',
                        help='Path to chainer model to load before trainig.')
    parser.add_argument('--vgg_init_model', type=str, default='',
                        help='Path to chainer model to load before trainig.')
    ...
    parser.add_argument('--vgg_im_size', type=int, default=224,
                        help='Set input size of your network')
    parser.add_argument('--traindata_path', type=str, default='dataset/mpii/self_train.csv',
                        help='Set training datafile')
    parser.add_argument('--testdata_path', type=str, default='dataset/mpii/self_val.csv',
    ...
    parser.add_argument('--pck_rate', type=float, default=20/368,
                        help='Set the rate for evalutating model')
    parser.add_argument('--image_path', type=str, default='',
                        help='Set the image path')
    parser.add_argument('--seg_path', type=str, default='',
                        help='Set the seg path')

    args = parser.parse_args()

    args.scale_range = list(map(float,args.scale_range.split(',')))
